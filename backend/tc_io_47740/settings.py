"""
Django settings for tc_io_47740 project.
...
WSGI_APPLICATION = 'tc_io_47740.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tc_io_47740 API",
    "DESCRIPTION": "API documentation for tc_io_47740 App",
    "VERSION": "v1",
}
